...
function mapStateToProps(state) { // map app state to component state?
    return { posts: state.posts }
}

export default connect(mapStateToProps, { fetchPosts })(PostsIndex); // wiring up the action creator